...
if __name__ == "__main__":
    logger.info("audio_list start. path=" + os.path.dirname(__file__) + os.sep + "AudioSyncData.xlsx")
    ...
    subprocess.run("xdg-open AudioSyncData.xlsx",cwd=os.path.dirname(__file__), shell=True)
