...
async def test_scanner_run_scan(scanner, db_session):
    ...
    mock_meta_1 = {
        "file_name": "song1", "title": "Song 1", "artist": "Artist 1", "duration": 180, "codec": "mp3"
    }
    mock_meta_2 = {
        "file_name": "song2", "title": "Song 2", "artist": "Artist 2", "duration": 200, "codec": "mp4"
    }

    with patch.object(scanner, '_scan_filesystem', return_value=mock_files) as mock_scan_fs, \
         patch.object(scanner, '_extract_metadata', side_effect=[mock_meta_1, mock_meta_2]) as mock_extract:
